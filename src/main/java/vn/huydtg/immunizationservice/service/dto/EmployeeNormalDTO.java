...
public class EmployeeNormalDTO implements Serializable {
    private UUID id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmployeeNormalDTO)) {
            return false;
        }

        EmployeeNormalDTO employeeNormalDTO = (EmployeeNormalDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, employeeNormalDTO.id);
    }
